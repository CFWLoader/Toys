from FP_growth.fptools import FpTree
...
def load_data(file_path, trans_method, limit):
    ...
    if limit is None:
        ...
        for line in src_data:
            ...
            tran_rec = frozenset(trans_method(line))
...
def FP_growth(fp_tree, min_sup=1, prefix=None, fre_item_list=None):
    ...
    for base_ptn, val in fp_tree.fre_list:
        ...
        gen_cond_ptn_bases += len(cond_ptn_bases)
    ...
    return fre_item_list, gen_cond_ptn_bases


if __name__ == '__main__':

    data_set = load_data('../data_src/house-votes-84.data')
