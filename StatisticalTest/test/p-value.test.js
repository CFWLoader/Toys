...
//     expect(result[5][0]).toBeCloseTo(4.30165803301067, 10);
//     expect(result[6][0]).toBeCloseTo(14.4191153154662, 5);
// });

test('Test gamma on AQI dataset.', () => {
    ...
    let availDist = filterDistributions(dataShape, ['gamma']);
    ...
    // console.log(availDist);
    expect(result[0][0]).toBeCloseTo(4.30165803301067, 10);
});