 ...
 */
test("fillMissingsWithMean(originalDataset) should trigger determinant zero error.", () => {
    expect(fillMissingsWithMean(originalDataset)).toThrowError("Cannot calculate inverse, determinant is zero");
});
